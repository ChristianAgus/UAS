...
Route::group(['prefix' => 'VisitorLogBook'], function () {
    Route::get('/', function () {
        return view('logbooks.index');
    })->name('logbooks.index')->middleware('auth');
    Route::get('/add', function () {
        return view('logbooks.addvisitor');
    })->name('logbooks.addvisitor')->middleware('auth');
    Route::get('/data', 'LogBookController@getlogbook')->name('getlogbook')->middleware('auth');
    Route::get('/add/getDivisi/{id}', 'LogBookController@getDivisi')->name('getDivisi')->middleware('auth');
    Route::get('/edit/getDivisi/{id}', 'LogBookController@getDivisi')->name('getDivisi')->middleware('auth');
    Route::get('/searchPegawai', 'LogBookController@searchPegawai')->name('searchPegawai')->middleware('auth');
    Route::post('/addVisitor', 'LogBookController@addVisitor')->name('addVisitor')->middleware('auth');
    Route::get('/delete/{id}', 'LogBookController@DestroyLogBook')->name('delete.logbook')->middleware('auth');
    Route::get('/edit/{id}', 'LogBookController@showEditForm')->name('logbooks.edit')->middleware('auth');
    Route::get('/detail/{id}', 'LogBookController@viewDetail')->name('logbooks.detail')->middleware('auth');
    Route::post('/VisitorLogBook/update/{id}', 'LogBookController@updateLogbook')->name('updateLogbook')->middleware('auth');
    Route::get('/LB-Report', function () {
        return view('logbooks.logreport');
    })->name('LBReport')->middleware('auth');
    Route::post('/LB-Report-Post', 'LogBookController@LBReport')->name('LBReportPOST')->middleware('auth');
    Route::post('//LB-Report-Excel', 'LogBookController@LBReportExcel')->name('LBReportExcel')->middleware('auth');
    Route::get('/get-visitor-data', 'LogBookController@getVisitorData')->name('getVisitorData');


});

Route::group(['prefix' => 'DeviceHP'], function () {
    Route::get('/', function () {
        return view('taskintern.datadevice');
    })->name('taskintern.datadevice')->middleware('auth');
    
    Route::get('/order', function () {
        return view('taskintern.order');
    })->name('taskintern.order')->middleware('auth');
    
    Route::get('/data', 'DeviceController@getDevice')->name('getDevice')->middleware('auth');
    Route::get('/invoice/{id}', 'DeviceController@viewInvoice1')->name('taskintern.invoice1')->middleware('auth');
    Route::get('/dataorder', 'DeviceController@getOrder')->name('getOrder')->middleware('auth');
    Route::put('/active-device/{id}', 'DeviceController@activeDevice')->name('activeDevice')->middleware('auth');
    Route::post('/add-order', 'DeviceController@AddOrder')->name('AddOrder')->middleware('auth');
    Route::post('/post', 'DeviceController@AddDevice')->name('AddDevice')->middleware('auth');
    Route::post('/import-devices', 'DeviceController@import')->name('import.devices')->middleware('auth');
    Route::get('/DeviceHP/export-pdf/{id}', 'DeviceController@exportPdf')->name('exportPdf')->middleware('auth');
    Route::get('/delete/{id}', 'DeviceController@deleteDevice')->name('device.delete')->middleware('auth');
    Route::get('/search/devices', 'DeviceController@searchDevices')->name('search.devices');
    Route::post('/get-device-details', 'DeviceController@getDeviceDetails')->name('getDeviceDetails')->middleware('auth');
});
