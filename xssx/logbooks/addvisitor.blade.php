    ...
    <div class="block block-fx-shadow">
        <div class="block block-themed block-transparent mb-0">
            <div class="block-header bg-gd-sea p-10">
                <h3 class="block-title"><i class="fa fa-user mr-1"></i> Add Visitor</h3>
            </div>
        </div>
        <div id="alert" class="alert" style="display: none;"></div>
        <form method="post" action="{{ route('addVisitor') }}" id="addVisitor" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control nama" id="addPengunjungName" name="pengunjung_name" required>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Company<span style="color: blue;"> *</span></label>
                        <div class="input-group">
                             <input type="text" class="form-control adress" id="addCompany" name="company" required>
                        </div>
                    </div>
                        <div class="form-group col-md-6">
                            <label for="addPegawai">Pegawai yang Ditemui<span style="color: blue;"> *</span></label>
                            <select class="js-select22 form-control" id="addPegawai" name="pegawai" required>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control discount" id="addDivisi" name="divisi" maxlength="11" required readonly>
                    </div>
                        <div class="form-group col-md-12">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" name="deskripsi" rows="5" placeholder="Tujuan Kunjungan *" required>{{ old('deskripsi') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-lg-10">
                                <div class="input-group">
                                    <select class="form-control js-select2 ftime" name="jam" style="width:100%;" required>
                                        <option value="" disabled selected>Please select</option>
                                        <?php
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control telp" id="addTelp" name="notelp" required maxlength="13" required>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>E-mail<span style="color: blue;"> </span></label>
                                <div class="input-group">
                                    <input type="email" class="form-control email" id="addEmail" name="email" required maxlength="50">
...
<script>
 $(document).ready(function () {
        ...
        $('#addPegawai').change(function () {
            var selectedUserId = $(this).val();
            $.ajax({
                url: '/VisitorLogBook/add/getDivisi/' + selectedUserId,
                type: 'GET',
                success: function (response) {
                    $('#addDivisi').val(response.divisi);
                },
                error: function (xhr) {
    ...
    $(document).on('submit', '#addVisitor', function (e) {
    e.preventDefault();
    var form = $(this);
