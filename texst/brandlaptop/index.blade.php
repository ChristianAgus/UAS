...
<script>
   $(document).ready(function () {
            ...
            $('.js-swal-delete2').click(function() {
          ...
          $("#dataTable").DataTable({
                drawCallback: function(){
                    ...
                    $('.js-swal-delete2').on('click', function(){
                            ...
                            swal({
                                title: 'Are you sure?',
                                text: 'This data will change its status!',
                                type: 'warning',
                                showCancelButton: true,
                                confirmButtonColor: '#d26a5c',
                                ...
                                if (result.value) {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            button.attr("title", response.newStatus == 'Active' ? 'Change to Inactive' : 'Change to Active');
                                            button.removeClass("btn-success btn-danger").addClass(response.newStatus == 'Active' ? 'btn-success' : 'btn-danger');
                                            button.html("<i class='si si-check mr-2'></i>" + response.newStatus);
                                        },
