...
Route::group(['prefix' => 'Brand'], function () {
    ...
    Route::get('/Brand/export-pdf/{id}', 'LaptopController@exportPdf')->name('exportPdf')->middleware('auth');
    Route::put('/active-laptop/{id}', 'LaptopController@activeLaptop')->name('activeLaptop')->middleware('auth');
});
...
Route::group(['prefix' => 'DeviceHP'], function () {
    ...
    Route::get('/get-order', 'DeviceController@getOrder')->name('getOrder')->middleware('auth');
